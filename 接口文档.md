...
* 请求类型：Post
* http://172.16.143.9:8000/api/user/login/
...
* 请求类型：Post
* http://172.16.143.9:8000/user/register/
...
* 请求类型：Get
* http://172.16.143.9:8000/api/user/logout/
...
- 请求类型：Post
- http://172.16.143.9:8000/api/user/get_profile/
...
- 请求类型：Post
- http://172.16.143.9:8000/api/user/update_profile/
...
- 请求类型 ：Post
- http://172.16.143.9:8000/api/course/submitproblem/
1. 请求参数
...
七、查询（具体）出题记录
- 请求类型:post
- http://172.16.143.9:8000/api/course/RequestProblem/
...
八、查询练习记录/具体某次练习记录
- 请求类型 : post
- http://172.16.143.9:8000/api/course/requestExerciseRecord/
1. 请求参数
...
九、 练习请求下一道题
- 请求类型 : post
- http://172.16.143.9:8000/api/course/requestNext/
1. 请求参数
...
十、 练习请求第一道题
- 请求类型 : post
- http://ip/course/requestNext/startExercise/
1. 请求参数
...
- 请求类型 : post
- http://ip/api/course/requestNext/submitAnswer/
1. 请求参数
