    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_imageprofile', to=settings.AUTH_USER_MODEL, verbose_name='用户头像')),
            ],
            options={
                'verbose_name': '头像',
